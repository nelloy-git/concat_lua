...
---@param data number
---@param lvl integer
function BladeMasterCriticalStrike:setCriticalStrikeChance(data, lvl) self:addField(WeField.new("Ocr1", 'unreal', lvl, 1, data)) end
---@param data number
---@param lvl integer
function BladeMasterCriticalStrike:setDamageBonus(data, lvl) self:addField(WeField.new("Ocr3", 'unreal', lvl, 3, data)) end
---@param data number
---@param lvl integer
function BladeMasterCriticalStrike:setEvadeChance(data, lvl) self:addField(WeField.new("Ocr4", 'unreal', lvl, 4, data)) end
---@param data number
---@param lvl integer
