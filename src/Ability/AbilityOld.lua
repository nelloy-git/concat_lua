...
local AbilityOldTypeOld = require('AbilityOld.Type')
---@type TimerClass
...
local AbilityOld = Class.new('AbilityOld')
---@class AbilityOld
local public = AbilityOld.public
---@class AbilityOldClass
local static = AbilityOld.static
---@type AbilityOldClass
local override = AbilityOld.override
local private = {}
...
---@param child_instance AbilityOld | nil
---@return AbilityOld
function override.new(owner, ability_type, child_instance)
    local instance = child_instance or Class.allocate(AbilityOld)
