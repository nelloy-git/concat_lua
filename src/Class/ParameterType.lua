...
private[static.Str].icon = Compiletime(Icon.BTNStrenghtAttribute)
...
private[static.Agi].icon = Compiletime(Icon.BTNAgilityAttribute)
...
private[static.Int].icon = Compiletime(Icon.BTNIntelligenceAttribute)
