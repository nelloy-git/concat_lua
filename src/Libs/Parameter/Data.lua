...
ParamData.Tooltip = {
    [ParamData.Type.PDmg] = fmt('Physical damage of unit attacks and most of physical abilities. Attacks deals %.0f-%.0f%% of this value as physical damage.', 100 * ParamData.Const.min_pdmg_attack, 100 * ParamData.Const.max_pdmg_attack),
