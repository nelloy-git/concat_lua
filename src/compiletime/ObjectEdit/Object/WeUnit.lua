...
---@param name string
---@param child_instance WeUnit | nil
---@return WeUnit
function override.new(id, base_id, name, child_instance)
    local instance = child_instance or Class.allocate(WeUnit)
...
static.Field.ScalingValue = WeField.new("usca", 'real', "ScalingValue")
...
static.Field.SpeedBase = WeField.new("umvs", 'int', "SpeedBase")
static.Field.SpeedMaximum = WeField.new("umas", 'int', "SpeedMaximum")
static.Field.SpeedMinimum = WeField.new("umis", 'int', "SpeedMinimum")
...
static.Field.Hero_IntelligencePerLevel = WeField.new("uinp", 'real', "IntelligencePerLevel")
static.Field.Hero_ItemsMade = WeField.new("umki", 'string', "ItemsMade")
static.Field.Hero_Level = WeField.new("ulev", 'int', "Level")
static.Field.Hero_NeutralBuildingShowsMinimapIcon = WeField.new("unbm", 'bool', "NeutralBuildingShowsMinimapIcon")
static.Field.Hero_NeutralBuildingValidAsRandomBuilding = WeField.new("unbr", 'bool', "NeutralBuildingValidAsRandomBuilding")
static.Field.Hero_PathingMap = WeField.new("upat", 'string', "PathingMap")
static.Field.Hero_PlacementPreventedBy = WeField.new("upar", 'string', "PlacementPreventedBy")
static.Field.Hero_PlacementRequires = WeField.new("upap", 'string', "PlacementRequires")
static.Field.Hero_PlacementRequiresWaterRadius = WeField.new("upaw", 'real', "PlacementRequiresWaterRadius")
...
static.Field.Hero_ResearchesAvailable = WeField.new("ures", 'string', "ResearchesAvailable")
static.Field.Hero_RevivesDeadHeros = WeField.new("urev", 'bool', "RevivesDeadHeros")
...
static.Field.Hero_UnitsTrained = WeField.new("utra", 'string', "UnitsTrained")
static.Field.Hero_UpgradesTo = WeField.new("uupt", 'string', "UpgradesTo")
...
static.Field.GroundTexture = WeField.new("uubs", 'string', "GroundTexture")
static.Field.HeroAbilities = WeField.new("uhab", 'string', "HeroAbilities")
static.Field.HeroRevivalLocations = WeField.new("urva", 'string', "HeroRevivalLocations")
static.Field.IntelligencePerLevel = WeField.new("uinp", 'real', "IntelligencePerLevel")
...
static.Field.PlacementRequiresWaterRadius = WeField.new("upaw", 'real', "PlacementRequiresWaterRadius")
static.Field.PrimaryAttribute = WeField.new("upra", 'string', "PrimaryAttribute")
static.Field.ProperNames = WeField.new("upro", 'string', "ProperNames")
static.Field.ProperNamesUsed = WeField.new("upru", 'int', "ProperNamesUsed")
...
static.Field.RevivesDeadHeros = WeField.new("urev", 'bool', "RevivesDeadHeros")
static.Field.StartingAgility = WeField.new("uagi", 'int', "StartingAgility")
static.Field.StartingIntelligence = WeField.new("uint", 'int', "StartingIntelligence")
static.Field.StartingStrength = WeField.new("ustr", 'int', "StartingStrength")
static.Field.StrengthPerLevel = WeField.new("ustp", 'real', "StrengthPerLevel")
static.Field.TooltipAwaken = WeField.new("uawt", 'string', "TooltipAwaken")
static.Field.TooltipRevive = WeField.new("utpr", 'string', "TooltipRevive")
