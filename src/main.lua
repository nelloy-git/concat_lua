...
UnitAddAbility(u:getHandleData(), FourCC('Ahea'))
BlzSetUnitAbilityManaCost(u:getHandleData(), FourCC('Ahea'), 0, 0)
local t = UtilsLib.Handle.Timer.new()
t:start(0.01, true,  function()
                        BlzStartUnitAbilityCooldown(u:getHandleData(), FourCC('Ahea'), 1, 0.5)
                    end)
